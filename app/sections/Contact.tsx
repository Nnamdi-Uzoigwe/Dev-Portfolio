              ...
              <div className="flex items-center gap-4 group">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-gray-900 font-semibold hover:text-[#8687e7] transition-colors duration-300"
                  >
        ...
        <div>
          <form className="bg-white/80 backdrop-blur-sm border border-white/20 shadow-sm rounded-3xl p-8 lg:p-12 space-y-8 h-fit">
            ...
            <button
              ...
              className="w-full bg-gradient-to-r from-[#8687e7] to-[#6e70ca] hover:from-[#6e70ca] hover:to-[#5a5cb8] text-white font-semibold py-4 px-8 rounded-xl transition-all duration-300 transform hover:scale-[1.02]  flex items-center justify-center gap-3 group"
            >
