...
export default function AboutMe() {
  ...
  return (
    <div id="about" className="fade-section bg-gray-100 px-6 lg:px-52 py-10">
      ...
      <div className="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-20">
        <div>
          <p className="text-left lg:text-justify">
            ...
            capabilities. While I&apos;m comfortable across the entire MERN
            stack, my heart truly lies in crafting beautiful, interactive user
            experiences. There&apos;s something magical about transforming
            designs into pixel-perfect, responsive interfaces that users love to
            interact with. <br />
            <br />
            ...
            diving deep into old-school music playlists. There&apos;s something
            about classic tracks that inspires my coding sessions - maybe
            it&apos;s the timeless quality that I try to bring to my development
            work.
          </p>
